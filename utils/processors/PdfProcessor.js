 ...
 * @param {Object} [options] - Options (pageStart, pageEnd, docId, imageAssetStorage)
            ...
            if (img && img.data) {
              ...
              if (pngBuffer) {
                ...
                if (saveToStorage) {
                  ...
                  // Legacy: return base64 (for backward compatibility)
                  collectedImages.push({
                    type: "base64",
                    mediaType: "image/png",
